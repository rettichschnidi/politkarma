...
from apps.curia_vista.models import AffairVote, FilteredAffairVoteTotal, Affair


class TestFilteredAffairVoteTotal(TestCase):
    def setUp(self):
        ...
        self.T = FilteredAffairVoteTotal(type='Yes', count=123, affair_vote=affair_vote)
